		...
		<div class="view-body">
			...
			<div class="view-product">
				<div class="manage-head">
					<h6 class="padding-left manage-head-con">已录取学生</h6>
				</div>
				<div class="manage-detail">
					<form id="search" name="search" method ="post" action = "TeacherStudentManageServlet">  
        				<input id="search" class="btn text-center login-btn" name ="search" type="submit" value="查询已录取学生名单" />
					</form>
				</div>
            ...
            if(stu_labList!= null && stu_labList.size() > 0){
            	for (int i = 0; i < stu_labList.size(); i++) {
		            ...
		            out.print("<div class='td w20 text-center'>"+student.getTelString()+"</div>");
		            out.print("<div class='td w25 text-center'>"+student.getMajorString()+"</div>");
		            out.print("</div>");
				}
            }
    		%>
