...
<div class="view-body">
				...
				<div class="authority">
					<div class="authority-head">
						<div class="manage-head">
							<h6 class="layout padding-left manage-head-con">成绩录入
							</h6>
						</div>
					</div>
		...
		<div class="main">
			<div class="login-dom">
				<form class="register-form" name="search" action="TeacherInputGrade3Servlet" method="post" autocomplete="off">
					<div class="num-box ">
						<div class="area fl">
							课题编号
						</div>
						<input type="text" name="labelnum" value="<%=labelnum%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							学生编号
						</div>
						<input type="text" name="studentnum" value="<%=studentnum%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							学生姓名
						</div>
						<input type="text" value="<%=student.getNameString()%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							学生专业
						</div>
						<input type="text" value="<%=student.getMajorString()%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							学生班级
						</div>
						<input type="text" value="<%=student.getClassString()%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							学生电话
						</div>
						<input type="text" value="<%=student.getTelString()%>" readonly="true" autofocus="true" id="num-name">
					</div>
					<div class="num-box ">
						<div class="area fl">
							成绩
						</div>
						<input type="text" autofocus="true" name="grade" id="num-name">
					</div>
					<div class="position">
						<input type="submit" class="btn text-center login-btn" value="确定录入">
					</div>
				</form>
			</div>	
			</div>	
